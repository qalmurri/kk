from PySide6.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QTableView, QPushButton, QMenu
from PySide6.QtGui import QAction # Diperlukan untuk membuat aksi menu
...
class MainWindow(QMainWindow):
    ...
    def _setup_menu_bar(self):
        ...
        # Aksi (Actions)
        self.action_refresh = QAction("Refresh Data", self)
