from PySide6.QtWidgets import QVBoxLayout, QHBoxLayout, QTableView, QMenu, QPushButton, QMessageBox
...
class DataTab(BasePersistentTableTab):
    ...
    def __init__(self, proxy, selection_model, parent=None):
        ...
        self.tool01 = QPushButton("New Scripts")
    ...
    def open_detail_window(self):
        ...
        dialog = DataDetailWindow(self.current_data, self)
        dialog.exec()
